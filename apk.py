...
leverage_mode = st.sidebar.radio(
    "Tryb Dźwigni", ["🤖 Autonomiczny (max 5x)", "🛡️ Ręczny"]
)
...
# =====================================================================
# LOGIKA BOTA I ZARZĄDZANIE POZYCJAMI Z FILTREM ADX ORAZ `fut_tf`
# =====================================================================
try:
  current_positions = []
  if futures_ex:
  ...
  try:
    ...
    if active_pos:
      ...
      for p in active_pos:
        ...
        signal_desc = trade_info.get("signal_name") or f"ADX + MACD ({fut_tf})"
